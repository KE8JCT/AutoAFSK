...
// APRS settings
char APRS_CALLSIGN[]="KE8JCT";
const int APRS_SSID=5;
char APRS_SYMBOL='>'; //pointer & print buffer ax25
//char AX25[255];
...
void setup()  
{
  ...
  aprs_update_timer_id=timer.setInterval(10L*60L*1000L, setAprsUpdateFlag);
}
...
void loop()
{
  ...
  Serial.println("Checking fore new data");
  if (newData)
  {
